export const oceanBiomes = [
    ...
    { name: 'deep-warm-ocean', altitude: -0.6, temperature: 0.6, humidity: 0.8, vegetation: 0.2 },
    { name: 'ocean', altitude: -0.5, temperature: 0.4, humidity: 0.8, vegetation: 0.3 },
...
export const landBiomes = [
    ...
    { name: 'arid-desert', altitude: 0.4, temperature: 0.8, humidity: 0.1, vegetation: 0.2 },
    { name: 'dunes', altitude: 0.3, temperature: 1, humidity: 0.05, vegetation: 0.15 },
    { name: 'mesa', altitude: 0.6, temperature: 0.9, humidity: 0.2, vegetation: 0.1 },
    { name: 'badlands', altitude: 0.5, temperature: 0.8, humidity: 0.1, vegetation: 0.1 },

    // Grasslands and plains
    { name: 'plain', altitude: 0.3, temperature: 0.5, humidity: 0.4, vegetation: 0.6 },
    { name: 'savanna', altitude: 0.4, temperature: 0.7, humidity: 0.3, vegetation: 0.5 },
    { name: 'steppe', altitude: 0.4, temperature: 0.6, humidity: 0.3, vegetation: 0.5 },
    { name: 'prairie', altitude: 0.3, temperature: 0.5, humidity: 0.5, vegetation: 0.7 },
    ...
    // Forests
    { name: 'forest', altitude: 0.4, temperature: 0.5, humidity: 0.7, vegetation: 0.8 },
    { name: 'redwood-forest', altitude: 0.6, temperature: 0.3, humidity: 0.6, vegetation: 0.7 },
    { name: 'savanna-forest', altitude: 0.4, temperature: 0.7, humidity: 0.5, vegetation: 0.6 },
    { name: 'temperate-forest', altitude: 0.5, temperature: 0.5, humidity: 0.6, vegetation: 0.7 },
    { name: 'boreal-forest', altitude: 0.6, temperature: 0.3, humidity: 0.5, vegetation: 0.6 },
    { name: 'deciduous-forest', altitude: 0.5, temperature: 0.5, humidity: 0.7, vegetation: 0.8 },
